...
#pragma __printf_args
extern __attribute__((nothrow)) int asprintf(char ** , const char * __restrict , ...) __attribute__((__nonnull__(2)));
extern __attribute__((nothrow)) int vasprintf(char ** , const char * __restrict , __va_list ) __attribute__((__nonnull__(2)));
...
# 1 "../Drivers/STM32F7xx_HAL_Driver/Inc\\stm32f7xx_hal_iwdg.h" 1
# 63 "../Drivers/STM32F7xx_HAL_Driver/Inc\\stm32f7xx_hal_iwdg.h"
typedef struct
{
  uint32_t Prescaler;
...
# 155 "../Drivers/STM32F7xx_HAL_Driver/Inc\\stm32f7xx_hal_iwdg.h"
HAL_StatusTypeDef HAL_IWDG_Init(IWDG_HandleTypeDef *hiwdg);
# 164 "../Drivers/STM32F7xx_HAL_Driver/Inc\\stm32f7xx_hal_iwdg.h"
HAL_StatusTypeDef HAL_IWDG_Refresh(IWDG_HandleTypeDef *hiwdg);
# 323 "../Inc\\stm32f7xx_hal_conf.h" 2
...
# 124 "../Drivers/BSP/STM32F746/stm32746g_qspi.h"
typedef struct {
  uint32_t FlashSize;
...
# 141 "../Drivers/BSP/STM32F746/stm32746g_qspi.h"
...
# 44 "C:\\Keil\\ARM\\ARMCLANG\\Bin\\..\\include\\string.h" 3
    typedef unsigned int size_t;
...
extern __attribute__((nothrow)) char *strtok_r(char * , const char * , char ** ) __attribute__((__nonnull__(2,3)));
...
# 76 "../Drivers/BSP/STM32F746/stm32746g_qspi.c" 2
# 95 "../Drivers/BSP/STM32F746/stm32746g_qspi.c"
QSPI_HandleTypeDef QSPIHandle;
QSPI_CommandTypeDef sCommand;
QSPI_AutoPollingTypeDef sConfig;
uint8_t configureMemoryMappedMode;
# 110 "../Drivers/BSP/STM32F746/stm32746g_qspi.c"
...
# 127 "../Drivers/BSP/STM32F746/stm32746g_qspi.c"
uint8_t MX_QSPI_Init(void)
{
    ...
    QSPIHandle.Instance = ((QUADSPI_TypeDef *) 0xA0001000U);
    HAL_QSPI_DeInit(&QSPIHandle) ;

    QSPIHandle.Init.ClockPrescaler = 2;
    QSPIHandle.Init.FifoThreshold = 4;
    QSPIHandle.Init.SampleShifting = ((uint32_t)(0x1U << (4U)));
    QSPIHandle.Init.FlashSize = 23;
    QSPIHandle.Init.ChipSelectHighTime = ((uint32_t)(0x1U << (8U)));
    QSPIHandle.Init.ClockMode = ((uint32_t)0x00000000U);
    QSPIHandle.Init.DualFlash = ((uint32_t)0x00000000U);
    QSPIHandle.Init.FlashID = ((uint32_t)0x00000000U);
...
# 171 "../Drivers/BSP/STM32F746/stm32746g_qspi.c"
    if(QSPI_AutoPollingMemReady(&QSPIHandle, ((uint32_t)5000)) != 1)
    {
        return 0;
    }
...
# 193 "../Drivers/BSP/STM32F746/stm32746g_qspi.c"
uint8_t BSP_QSPI_Read(uint8_t* pData, uint32_t ReadAddr, uint32_t Size)
{
  ...
  if (HAL_QSPI_Command(&QSPIHandle, &s_command, ((uint32_t)5000)) != HAL_OK)
  {
    return ((uint8_t)0x01);
  }


  (((QSPIHandle.Instance->DCR)) = ((((((QSPIHandle.Instance->DCR))) & (~((0x7U << (8U))))) | (((uint32_t)(0x2U << (8U)))))));


  if (HAL_QSPI_Receive(&QSPIHandle, pData, ((uint32_t)5000)) != HAL_OK)
  {
    return ((uint8_t)0x01);
  }


  (((QSPIHandle.Instance->DCR)) = ((((((QSPIHandle.Instance->DCR))) & (~((0x7U << (8U))))) | (((uint32_t)(0x4U << (8U)) | (0x1U << (8U)))))));

  return ((uint8_t)0x00);
}
# 239 "../Drivers/BSP/STM32F746/stm32746g_qspi.c"
uint8_t BSP_QSPI_Write(uint8_t* pData, uint32_t WriteAddr, uint32_t Size)
{
  QSPI_CommandTypeDef s_command;
  ...
  do
  {
    ...
    if (QSPI_WriteEnable(&QSPIHandle) != ((uint8_t)0x00))
    {
      return ((uint8_t)0x01);
    }
    ...
    if (HAL_QSPI_Transmit(&QSPIHandle, pData, ((uint32_t)5000)) != HAL_OK)
    {
      return ((uint8_t)0x01);
    }


    if (QSPI_AutoPollingMemReady(&QSPIHandle, ((uint32_t)5000)) != ((uint8_t)0x00))
    {
      return ((uint8_t)0x01);
    }
...
uint8_t BSP_QSPI_Erase_Block(uint32_t BlockAddress)
{
  ...
  if (QSPI_AutoPollingMemReady(&QSPIHandle, 800) != ((uint8_t)0x00))
  {
    return ((uint8_t)0x01);
  }
...
uint8_t BSP_QSPI_Erase_Chip(void)
{
  ...
  if (QSPI_AutoPollingMemReady(&QSPIHandle, 250000) != ((uint8_t)0x00))
  {
    return ((uint8_t)0x01);
  }
...
uint8_t BSP_QSPI_GetStatus(void)
{
  ...
  if (HAL_QSPI_Receive(&QSPIHandle, &reg, ((uint32_t)5000)) != HAL_OK)
  {
    return ((uint8_t)0x01);
  }
...
uint8_t BSP_QSPI_EnableMemoryMappedMode(void)
{
    ...
    if (!MemoryMappedMode)
    {
        ...
        sCommand.InstructionMode = ((uint32_t)(0x1U << (8U)));
        sCommand.AddressSize = ((uint32_t)(0x2U << (12U)));
        sCommand.AlternateByteMode = ((uint32_t)0x00000000U);
        sCommand.AlternateBytesSize = ((uint32_t)0x00000000U);
        sCommand.DdrMode = ((uint32_t)0x00000000U);
        sCommand.DdrHoldHalfCycle = ((uint32_t)0x00000000U);
        sCommand.SIOOMode = ((uint32_t)0x00000000U);

        sCommand.AddressMode = ((uint32_t)(0x3U << (10U)));
        sCommand.Address = 0;
        sCommand.DataMode = ((uint32_t)(0x3U << (24U)));
        sCommand.NbData = 0;
        sCommand.Instruction = 0xEB;
        sCommand.DummyCycles = 10;

        sMemMappedCfg.TimeOutActivation = ((uint32_t)0x00000000U);
...
# 522 "../Drivers/BSP/STM32F746/stm32746g_qspi.c"
HAL_StatusTypeDef HAL_QSPI_DeInit(QSPI_HandleTypeDef *hqspi)
{

  if(QSPIHandle.Instance == 0)
  {
    return HAL_ERROR;
  }


  do{ if((&QSPIHandle)->Lock == HAL_LOCKED) { return HAL_BUSY; } else { (&QSPIHandle)->Lock = HAL_LOCKED; } }while (0);


  (((&QSPIHandle)->Instance->CR) &= ~((0x1U << (0U))));


  HAL_QSPI_MspDeInit(&QSPIHandle);


  QSPIHandle.ErrorCode = ((uint32_t)0x00000000U);


  QSPIHandle.State = HAL_QSPI_STATE_RESET;


  do{ (&QSPIHandle)->Lock = HAL_UNLOCKED; }while (0);
...
# 638 "../Drivers/BSP/STM32F746/stm32746g_qspi.c"
}
# 648 "../Drivers/BSP/STM32F746/stm32746g_qspi.c"
void HAL_QSPI_MspDeInit(QSPI_HandleTypeDef *hqspi)
{
    ...
    hdma.Instance = ((DMA_Stream_TypeDef *) (((0x40000000U + 0x00020000U) + 0x6400U) + 0x0B8U));
    HAL_DMA_DeInit(&hdma);
...
static uint8_t QSPI_DummyCyclesCfg(QSPI_HandleTypeDef *hqspi)
{
    ...
    sCommand.InstructionMode = ((uint32_t)(0x1U << (8U)));
    sCommand.Instruction = 0x85;
    sCommand.AddressMode = ((uint32_t)0x00000000U);
    sCommand.AlternateByteMode = ((uint32_t)0x00000000U);
    sCommand.DataMode = ((uint32_t)(0x1U << (24U)));
    ...
    if (HAL_QSPI_Command(&QSPIHandle, &sCommand, ((uint32_t)5000)) != HAL_OK)
    {
        return 0;
    }
    ...
    if (HAL_QSPI_Transmit(&QSPIHandle, &reg, ((uint32_t)5000)) != HAL_OK)
    {
        return 0;
    }
...
static uint8_t QSPI_WriteEnable(QSPI_HandleTypeDef *hqspi)
{
    ...
    sCommand.AddressMode = ((uint32_t)0x00000000U);
    sCommand.AlternateByteMode = ((uint32_t)0x00000000U);
    sCommand.DataMode = ((uint32_t)0X00000000);
    sCommand.DummyCycles = 0;
    sCommand.DdrMode = ((uint32_t)0x00000000U);
    sCommand.DdrHoldHalfCycle = ((uint32_t)0x00000000U);
    sCommand.SIOOMode = ((uint32_t)0x00000000U);
    ...
    sConfig.Match = 0x02;
    sConfig.Mask = 0x02;
    sConfig.MatchMode = ((uint32_t)0x00000000U);
    sConfig.StatusBytesSize = 1;
    sConfig.Interval = 0x10;
    sConfig.AutomaticStop = ((uint32_t)(0x1U << (22U)));

    sCommand.Instruction = 0x05;
    sCommand.DataMode = ((uint32_t)(0x1U << (24U))) ;
    sCommand.NbData = 1;

    if (HAL_QSPI_AutoPolling(&QSPIHandle, &sCommand, &sConfig, ((uint32_t)5000)) != HAL_OK)
    {
        return 0;
    }
