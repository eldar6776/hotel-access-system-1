...
# 111 "../Inc\\main.h"
extern volatile uint32_t sys_flags;

extern volatile uint32_t fan_rpm_pulse;
...
extern volatile uint8_t display_image_id, display_image_time;
# 169 "../Inc\\display.h"
...
static void RAM_Init(void)
{
    ...
    BSP_EEPROM_ReadBuffer(ee_buff, ((uint16_t)0x0000U), &bt);
...
static void MPU_Config(void)
{
 ...
 ((FMC_Bank1_TypeDef *) (0xA0000000U + 0x0000U))->BTCR[0] = 0x000030D2U;
}
...
static void SystemClock_Config(void)
{
 ...
 PeriphClkInitStruct.PeriphClockSelection = ((uint32_t)0x00000008U)
...
static void MX_TIM9_DeInit(void)
{
 ...
 HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1000U)), ((uint16_t)0x0020U));
...
static void MX_I2C4_DeInit(void)
{
    ...
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)), ((uint16_t)0x1000U) | ((uint16_t)0x2000U));
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1800U)), ((uint16_t)0x0004U));
...
static void MX_GPIO_DeInit(void)
{
 HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0800U)), ((uint16_t)0x0100U));
 HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)), ((uint16_t)0x0080U));
    HAL_GPIO_DeInit(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1800U)), ((uint16_t)0x2000U)|((uint16_t)0x4000U));
...
static void TOUCH_SCREEN_Service(void)
{
    ...
    else (ts_update_timer = HAL_GetTick() + 25U);
    ...
    if(((sys_flags & (1U << 0)) != 0U))
 {
        switch (buzzer_signal_id)
        {
            ...
            case 2U:
            {
                if(HAL_GetTick() > buzzer_mode_timer)
                {
                    if(buzzer_pcnt == 0U)
                    {
                        ...
                        {
                            (HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)), ((uint16_t)0x0010U), GPIO_PIN_SET));
                            buzzer_mode_timer = HAL_GetTick() + 100U;
                            ++buzzer_pcnt;
                        }
                    }
                    else if(buzzer_pcnt == 1U)
                    {
                        (HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)), ((uint16_t)0x0010U), GPIO_PIN_RESET));
                        buzzer_pcnt = 0U;
                        if(buzzer_signal_time == 0U) buzzer_mode_timer = HAL_GetTick() + 100U;
            ...
            case 3U:
            {
                if(HAL_GetTick() > buzzer_mode_timer)
                {
                    if(buzzer_pcnt == 0U)
                    {
                        ...
                        {
                            (HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)), ((uint16_t)0x0010U), GPIO_PIN_SET));
                            buzzer_mode_timer = HAL_GetTick() + 500U;
                            ++buzzer_pcnt;
                        }
                    }
                    else if(buzzer_pcnt == 1U)
                    {
                        (HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)), ((uint16_t)0x0010U), GPIO_PIN_RESET));
                        buzzer_pcnt = 0U;
                        if(buzzer_signal_time == 0U) buzzer_mode_timer = HAL_GetTick() + 500U;
                        else buzzer_repeat_timer = (HAL_GetTick() + (buzzer_signal_time * 1000U));
                    }
                }
                break;
                ...
                if(HAL_GetTick() > buzzer_mode_timer)
                {
                    if((buzzer_pcnt == 0U))
                    {
                        if(HAL_GetTick() > buzzer_repeat_timer)
                        {
                            (HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)), ((uint16_t)0x0010U), GPIO_PIN_SET));
                            ++buzzer_pcnt;
                            buzzer_mode_timer = HAL_GetTick() + 1000U;
                        }
                    }
                    else if(buzzer_pcnt == 1U)
                    {
                        (HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)), ((uint16_t)0x0010U), GPIO_PIN_RESET));
                        buzzer_pcnt = 0U;
                        if(buzzer_signal_time == 0U) buzzer_mode_timer = HAL_GetTick() + 1000U;
                        else buzzer_repeat_timer = (HAL_GetTick() + (buzzer_signal_time * 1000U));
                    }
                }
                break;
            ...
            case 1U:
            {
                ...
                {
                    (HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)), ((uint16_t)0x0010U), GPIO_PIN_SET));
                    buzzer_mode_timer = HAL_GetTick() + 20U;
                    ++buzzer_pcnt;
                }
                else if(buzzer_pcnt == 1U)
                {
