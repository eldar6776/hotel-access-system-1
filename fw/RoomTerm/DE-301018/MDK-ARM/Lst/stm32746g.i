...
# 48 "../Drivers/BSP/STM32F746/stm32746g.c" 2
...
static void I2Cx_MspInit(I2C_HandleTypeDef *i2c_handler)
{
 ...
 GPIO_InitStruct.Pin = ((uint16_t)0x2000U);
 GPIO_InitStruct.Mode = ((uint32_t)0x00000012U);
 GPIO_InitStruct.Pull = ((uint32_t)0x00000000U);
 GPIO_InitStruct.Speed = ((uint32_t)0x00000003U);
 GPIO_InitStruct.Alternate = ((uint8_t)0x04U);
 HAL_GPIO_Init(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x0C00U)), &GPIO_InitStruct);
    ...
    HAL_GPIO_WritePin(((GPIO_TypeDef *) ((0x40000000U + 0x00020000U) + 0x1800U)), ((uint16_t)0x0004U), GPIO_PIN_RESET);
 ...
 do { volatile uint32_t tmpreg; ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR) |= ((0x1U << (24U)))); tmpreg = ((((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1ENR) & ((0x1U << (24U)))); ((void)(tmpreg)); } while(0);


 (((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1RSTR |= ((0x1U << (24U))));


 (((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1RSTR &= ~((0x1U << (24U))));
# 519 "../Drivers/BSP/STM32F746/stm32746g.c"
}
# 528 "../Drivers/BSP/STM32F746/stm32746g.c"
static void I2Cx_Init(I2C_HandleTypeDef *i2c_handler)
{
 if(HAL_I2C_GetState(i2c_handler) == HAL_I2C_STATE_RESET)
 {
  i2c_handler->Instance = ((I2C_TypeDef *) (0x40000000U + 0x6000U));
...
# 556 "../Drivers/BSP/STM32F746/stm32746g.c"
...
# 586 "../Drivers/BSP/STM32F746/stm32746g.c"
...
# 614 "../Drivers/BSP/STM32F746/stm32746g.c"
static HAL_StatusTypeDef I2Cx_IsDeviceReady(I2C_HandleTypeDef *i2c_handler, uint16_t DevAddress, uint32_t Trials)
{
...
# 644 "../Drivers/BSP/STM32F746/stm32746g.c"
void AUDIO_IO_Init(void)
{
...
# 664 "../Drivers/BSP/STM32F746/stm32746g.c"
void AUDIO_IO_Write(uint8_t Addr, uint16_t Reg, uint16_t Value)
{
  uint16_t tmp = Value;
...
# 724 "../Drivers/BSP/STM32F746/stm32746g.c"
void CAMERA_IO_Write(uint8_t Addr, uint8_t Reg, uint8_t Value)
{
...
# 773 "../Drivers/BSP/STM32F746/stm32746g.c"
HAL_StatusTypeDef EEPROM_IO_WriteData(uint16_t DevAddress, uint16_t MemAddress, uint8_t* pBuffer, uint32_t BufferSize)
{
  return (I2Cx_WriteMultiple(&hi2c4, DevAddress, MemAddress, (0x00000002U), pBuffer, BufferSize));
}
# 786 "../Drivers/BSP/STM32F746/stm32746g.c"
HAL_StatusTypeDef EEPROM_IO_ReadData(uint16_t DevAddress, uint16_t MemAddress, uint8_t* pBuffer, uint32_t BufferSize)
{
  return (I2Cx_ReadMultiple(&hi2c4, DevAddress, MemAddress, (0x00000002U), pBuffer, BufferSize));
}
# 798 "../Drivers/BSP/STM32F746/stm32746g.c"
HAL_StatusTypeDef EEPROM_IO_IsDeviceReady(uint16_t DevAddress, uint32_t Trials)
{
...
void TS_IO_Init(void)
{
    ...
    {
        hi2c3.Instance = ((I2C_TypeDef *) (0x40000000U + 0x5C00U));
        ...
        (((RCC_TypeDef *) ((0x40000000U + 0x00020000U) + 0x3800U))->APB1RSTR &= ~((0x1U << (23U))));
# 866 "../Drivers/BSP/STM32F746/stm32746g.c"
        HAL_I2C_Init(&hi2c3);
    }
}
# 877 "../Drivers/BSP/STM32F746/stm32746g.c"
void TS_IO_Write(uint8_t Addr, uint8_t Reg, uint8_t Value)
{
    I2Cx_WriteMultiple(&hi2c3, Addr, (uint16_t)Reg, (0x00000001U),(uint8_t*)&Value, 1);
}
...
uint8_t TS_IO_Read(uint8_t Addr, uint8_t Reg)
{
    ...
    I2Cx_ReadMultiple(&hi2c3, Addr, Reg, (0x00000001U), (uint8_t*)&read_value, 1);
