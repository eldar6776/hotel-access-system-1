...
# 671 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_qspi.c"
HAL_StatusTypeDef HAL_QSPI_Command_IT(QSPI_HandleTypeDef *hqspi, QSPI_CommandTypeDef *cmd)
{
  HAL_StatusTypeDef status = HAL_ERROR;
  uint32_t tickstart = HAL_GetTick();
...
# 1206 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_qspi.c"
HAL_StatusTypeDef HAL_QSPI_Receive_DMA(QSPI_HandleTypeDef *hqspi, uint8_t *pData)
{
  HAL_StatusTypeDef status = HAL_OK;
  uint32_t *tmp;
...
# 1979 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_qspi.c"
static void QSPI_DMARxCplt(DMA_HandleTypeDef *hdma)
{
...
# 2094 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_qspi.c"
...
# 2127 "../Drivers/STM32F7xx_HAL_Driver/Src/stm32f7xx_hal_qspi.c"
static void QSPI_Config(QSPI_HandleTypeDef *hqspi, QSPI_CommandTypeDef *cmd, uint32_t FunctionalMode)
{
  ((void)0U);
