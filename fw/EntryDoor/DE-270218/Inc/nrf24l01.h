...
#define RADIO_ModulPresent()			(radio_flags |= (1 << 2))
#define RADIO_ModulNotPresent()			(radio_flags &= (~(1 << 2)))
#define IsRADIO_ModulPresent()			((radio_flags & (1 << 2)) != 0)
