 ...
 ******************************************************************************
 *
 *	RS485 DEFAULT INTERFACE ADDRESS         0x0001
...
#ifndef __RS485_H__
#define __RS485_H__					170318	// version
...
/** ==========================================================================*/
#define RS485_DEFAULT_INTERFACE_ADDRESS     ((uint16_t)0x0001U)
#define RS485_DEFAULT_GROUP_ADDRESS         ((uint16_t)0x6776U)
#define RS485_DEFAULT_BROADCAST_ADDRESS     ((uint16_t)0x9999U)
...
extern uint32_t receiving_errors;
...
/* Exported macros     -------------------------------------------------------*/
#define SYS_NewLogSet()						(sys_status |= (1U << 0))
#define SYS_NewLogReset()					(sys_status &= (~ (1U << 0)))
#define IsSYS_NewLogSet()					((sys_status & (1U << 0)) != 0U)

#define SYS_LogListFullSet()				(sys_status |= (1U << 1))
#define SYS_LogListFullReset()				(sys_status &= (~ (1U << 1)))
#define IsSYS_LogListFullSet()				((sys_status & (1U << 1)) != 0U)

#define SYS_FileTransferSuccessSet()		(sys_status |= (1U << 2))
#define SYS_FileTransferSuccessReset()		(sys_status &= (~ (1U << 2)))
#define IsSYS_FileTransferSuccessSet()		((sys_status & (1U << 2)) != 0U)

#define SYS_FileTransferFailSet()			(sys_status |= (1U << 3))
#define SYS_FileTransferFailReset()			(sys_status &= (~ (1U << 3)))
#define IsSYS_FileTransferFailSet()			((sys_status & (1U << 3)) != 0U)

#define SYS_UpdateSuccessSet()				(sys_status |= (1U << 4))
#define SYS_UpdateSuccessReset()			(sys_status &= (~ (1U << 4)))
#define IsSYS_UpdateSuccessSet()			((sys_status & (1U << 4)) != 0U)

#define SYS_UpdateFailSet()					(sys_status |= (1U << 5))
#define SYS_UpdateFailReset()				(sys_status &= (~ (1U << 5)))
#define IsSYS_UpdateFailSet()				((sys_status & (1U << 5)) != 0U)

#define SYS_ImageUpdateRequestSet()			(sys_status |= (1U << 6))
#define SYS_ImageUpdateRequestReset()		(sys_status &= (~ (1U << 6)))
#define IsSYS_ImageUpdateRequestSet()		((sys_status & (1U << 6)) != 0U)

#define SYS_FirmwareUpdateRequestSet()		(sys_status |= (1U << 7))
#define SYS_FirmwareUpdateRequestReset()	(sys_status &= (~ (1U << 7)))
#define IsSYS_FirmwareUpdateRequestSet()	((sys_status & (1U << 7)) != 0U)
