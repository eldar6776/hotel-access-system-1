 ...
 */
#ifndef __SIGNAL_H__
#define __SIGNAL_H__					170318	// version
...
/* Macros     ----------------------------------------------------------------*/
#define SIGNAL_ExpiryTimeFromGuestCardSet()             (signal_flags |= (1U << 0))
#define SIGNAL_ExpiryTimeFromGuestCardReset()	        (signal_flags &= (~ (1U << 0)))
#define IsSIGNAL_ExpiryTimeFromGuestCardSet()	        ((signal_flags & (1U << 0)) != 0U)
